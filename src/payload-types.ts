...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "HeroPageBannerBlock".
 */
export interface HeroPageBannerBlock {
  title: string;
  description?: {
    root: {
      type: string;
...
export interface CarouselBlock {
  slides?:
    | {
        /**
         * Slide headline. Bold is the only inline style available.
         */
        title: {
          root: {
            type: string;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        'hero-page-banner'?: T | HeroPageBannerBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "HeroPageBannerBlock_select".
 */
export interface HeroPageBannerBlockSelect<T extends boolean = true> {
  title?: T;
  description?: T;
  logoImage?: T;
  secondaryImage?: T;
